...
//    }
    ...
    fun getDrawable(res: Resources, source: Pair<Bitmap, Int>): Drawable {
        val rotatedBitmap =
            Bitmap.createBitmap(
                source.first,
                0,
    ...
    fun loadBackground() {
        if (model.cachedBitmapWithOrientation != null) {
            background = getDrawable(resources, model.cachedBitmapWithOrientation!!)
        }
    }
}
